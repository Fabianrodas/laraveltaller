        ...
        <p class="fs-1">Listado de proyectos</p>
            <form action="{{ route('project.update', $solicitudes->id) }}" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="id" name="id" value="{{$solicitudes->id}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="inputGroup-sizing-default">Tema</span>
                    <input type="text" class="form-control" id="tema" name="tema" value="{{$solicitudes->tema}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                </div>
                <div class="input-group">
                    <span class="input-group-text">Descripcion</span>
                    <textarea class="form-control" id="descripcion" name="descripcion" value="{{$solicitudes->descripcion}}" aria-label="With textarea"></textarea>
                </div>
                ...
                <div class="input-group mb-3 mt-3">
                    ...
                    <select class="form-select" id="estado" name="estado" value="{{$solicitudes->estado}}" aria-label="Default select example">
                ...
                <div class="input-group mb-3 mt-3">
                    ...
                    <textarea class="form-control" id="observacion" name="observacion" value="{{$solicitudes->observacion}}" aria-label="With textarea"></textarea>
                </div>
                <div class="input-group mb-3 mt-3">
  <input type="hidden" name="usuarioExterno" value="0">
  <div class="input-group-text">
    <input type="checkbox" class="form-check-input mt-0" id="usuarioExterno" name="usuarioExterno" value="{{$solicitudes->usuarioExterno}}"  value="1" aria-label="Checkbox para usuario externo">
  </div>
